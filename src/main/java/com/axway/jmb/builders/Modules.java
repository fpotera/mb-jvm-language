...
public class Modules {
	...
	public static void buildGetModuleMethod( ClassVisitor cv, Type classType) {
		...
		mv = new CheckMethodAdapter(ACC_PUBLIC + ACC_STATIC, "getModule", "()L"+classType.getInternalName()+";", mv, new HashMap<Label,Integer>());
